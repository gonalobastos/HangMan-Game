...
//ELEMENTAR-------------------------------------------------------------------------------------
int Jogo:: startElementar(string palavra, string tema){
    //Variaveis de jogo
    char palpite;
    bool correto = false;
    int aux;
...
//BASICO----------------------------------------------------------------------------------------
int Jogo:: startBasico(string palavra, string tema){
...
//MEDIO-------------------------------------------------------------------------------------------------
int Jogo:: startMedio(string palavra, string tema){
